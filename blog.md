...
The first week of build season is when the team collectively decides on a general strategy to pursue for the remainder of the season.
We ultimately decided that our robot will be built to place blocks on the scale and switch with additional mechanisms to climb during
the endgame. We also started prototyping several mechanisms to determine how these goals can be most effectively achieved.

Since the mechanisms for the scale and switch essentially perform the same functions at different heights, we decided the most efficient design
...
Our team narrowed the potential options for our intake / outtake system down to two designs. The first design involved two flywheels with
dynamic spacing that could be adjusted to account for different orientations of the power cubes; spinning the flywheels in one direction
will allow the robot to grip onto the cube, and spinning in the other direction releases it.

The second approach to intake / outtake that we considered was a claw mechanism powered by pneumatics. In this design, a double piston extends
to lock onto a cube, and retracts to release it. The end-game task for FIRST Power-Up involves lifting
our robot at least a foot off the ground using the rung at the top of the scale to support it. Throughout the week, our team conceptualized
and tested many prototypes for a climbing mechanism that could effectively achieve this task. In the example below, our team tested the
viability of using measuring tape to lift our robot by determining the maximum weight it could support. 

The programming team discussed the structure of the robot’s program for this year’s game. Both novice and experienced programmers experimented
with different sensors, like ultrasonic sensors and quadrature encoders, to determine the best way to monitor every action of this year’s robot.
Our team is thankful to our sponsors for supporting us so that we could provide electronics test boards for our programmers to test their ideas,
...
<h3><a name="2018kickoff">Kickoff Day!</a></h3>
...
![High Goal Shooter Vision Test](/assets/img/2017_blog/shooter.gif)
...
<img src="/assets/img/2017_blog/andy_program.JPG" alt="Programmers test shooter code deployed onto the prototype shooter." class="picture-height"/>
...
<img src="/assets/img/2017_blog/sejal_mechanical.JPG" alt="Brian Cruz guides a new member in mounting the final electrical board onto the chassis. " class="picture-height"/>
...
<img src="/assets/img/2017_blog/alex_cart.jpeg" alt="Alex Lee grabs materials from the robotics cart holding last year’s robot" class="picture-height"/>
...
<img src="/assets/img/2017_blog/andy_teaching.jpeg" alt="Andy Sheu lectures on the specifics of the robot's program" class="picture-height"/>
...
<img src="/assets/img/2017_blog/justin_wiring.jpeg" alt="Justin Quan installs the electrical board on our new robot’s chassis" class="picture-height"/>
...
<img src="/assets/img/2017_blog/brian_crimping.jpeg" alt="Brian Cruz strips and crimps wires to be put on the electrical board" class="picture-height"/>
...
<img src="/assets/img/2017_blog/paul-cadding.jpeg" alt="Paul Rubino adds finishing touches to the CAD" class="picture-height"/>
...
<img src="/assets/img/2017_blog/group-drivetrain.jpeg" alt="Gautam Prabhu teaches other members how to place the wheels onto the chassis with the newly-broached sprockets" class="picture-height"/>
...
<img src="/assets/img/2017_blog/ben-lathing.jpeg" alt="Ben Coe teaches underclassmen how to use the lathe" class="picture-height"/>
...
![Isabella Gueth welding](/assets/img/2017_blog/isabella_welding.gif)

Quentin Leon explores possibilities of vision and PID programming.

<img src="/assets/img/2017_blog/quentin-programming.jpeg" alt="Quentin Leon explores possibilities of vision and PID programming" class="picture-height"/>
...
<img src="/assets/img/2017_blog/harrison-machining.jpeg" alt="Harrison Van Der Walt and Jacob Snyder machining prototype parts" class="picture-height"/>
...
<img src="/assets/img/2017_blog/jake_cadding.JPG" alt="Jake Caligiuri works on a rough CAD of our robot's chassis" class="picture-height"/>

Ben Coe designs a gear-manipulating mechanism

<img src="/assets/img/2017_blog/ben_cadding.JPG" alt="Ben Coe designs a gear-manipulating mechanism" class="picture-height"/>
...
<img src="/assets/img/2017_blog/justin_programming.JPG" alt="Justin Quan attempts to program the IMU (inertial measurement unit) on our robot used for testing (the kitbot)" class="picture-height"/>

Talal Sohail closely investigates the electronics on our kitbot

<img src="/assets/img/2017_blog/talal_electrical.JPG" alt="Talal Sohail closely investigates the electronics on our kitbot" class="picture-height"/>
...
<img src="/assets/img/2017_blog/week_one_breakfast.JPG" alt="Week One Kickoff Breakfast" class="picture-height"/>

Team members discuss prototype ideas for gear manipulation

<img src="/assets/img/2017_blog/week_one_jerry_gear.JPG" alt="Team member discusses prototype ideas" class="picture-height"/>

Team members form groups to discuss prototype ideas

<img src="/assets/img/2017_blog/week_one_prototype_meeting.JPG" alt="Team members discuss prototype ideas" class="picture-height"/>
...
![Fuel Intake Prototype](/assets/img/2017_blog/intake_prototype.gif)
...
![Low Goal Shooter Prototype](/assets/img/2017_blog/lowgoal_prototype.gif)
...
![High Goal Prototype](/assets/img/2017_blog/highgoal_prototype.gif)
...
![Rope Climbing Prototype](/assets/img/2017_blog/climber_prototype.gif)
